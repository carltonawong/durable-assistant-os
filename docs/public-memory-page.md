...
<!-- DAOS baseline note: Current public framework baseline is v0.2.6; this file remains part of the current release surface even if its original feature landed in an earlier patch. -->
